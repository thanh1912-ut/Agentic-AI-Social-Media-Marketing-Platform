...
- Python 3.11.16 và Node 26.7.0 có sẵn. Docker/Podman và MinIO không khả dụng. PostgreSQL 18.3 + pgvector 0.8.2 disposable cluster riêng đã chạy migration 0001→0009 và rerun; runtime smoke tiếp theo xác nhận FastAPI readiness với PostgreSQL/Redis/local storage và Celery tiêu thụ recovery task rỗng. Scheduler, ingestion task, restart recovery trên job tồn tại và Compose chưa được kiểm tra. Runtime test cô lập, PostgreSQL 15 trên máy không bị thay đổi.
