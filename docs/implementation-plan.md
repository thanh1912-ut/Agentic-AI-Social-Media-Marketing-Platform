...
- Đánh giá embedding hiện chỉ là calibration synthetic: 12 truy vấn holdout đạt Hit@1 75%, Hit@3 91.7%, MRR 0.850; model load lạnh khoảng 17 giây và encode 12 passages + 12 queries khoảng 0.11 giây trên Apple M2 16 GB. Cỡ mẫu nhỏ, chưa dùng tài liệu SME thật; không xem là nghiệm thu chất lượng hay latency production.
