...
export type ApiSaveRecommendationRequest = Schemas['SaveRecommendationRequest'];
export type ApiRecommendationFeedbackRequest = Schemas['RecommendationFeedbackRequest'];
export type ApiAnalyticsRecommendationRecord = Schemas['AnalyticsRecommendationRecordOut'];
export type ApiApplyRecommendationRequest = Schemas['ApplyRecommendationRequest'];
