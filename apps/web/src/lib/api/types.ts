...
export type ApiResetPasswordResponse = Schemas['ResetPasswordResponse'];
export type ApiInvitationPreview = Schemas['InvitationPreviewOut'];
...
export type ApiMetaConnection = Schemas['MetaConnectionOut'];
export type ApiMetaPagePost = Schemas['MetaPagePostOut'];
export type ApiMetaPagePosts = Schemas['MetaPagePostsOut'];
export type ApiMetaPublication = Schemas['MetaPublicationOut'];
export type ApiMetaPublishRequest = Schemas['MetaPublishIn'];
export type ApiMetaReconcileRequest = Schemas['MetaReconcileIn'];
